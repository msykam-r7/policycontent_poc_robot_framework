...
Windows 2019-CIS Benchmarks
    ...
    [Teardown]    Safe Cleanup Test Resources    ${results}
    ...
    ...    os_benchmark_identifier=Windows_Server_2019_Standard_CIS_Benchmark,Microsoft_Windows_Server_2019_Stand-alone
    ...    version=3.0.0
    ...    scan_template=cis
    ...    server_service=ssh
    ...    scope=S
